...
var R = Math.pow,
  w = (i, e, t) => (e in i ? N(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (i[e] = t)),
  L = (i, e) => {
    for (var t in e || (e = {})) j.call(e, t) && w(i, t, e[t]);
    if (M) for (var t of M(e)) H.call(e, t) && w(i, t, e[t]);
    return i;
  };
...
function F(i = {}) {
  ...
  "PointerEvent" in window
    ? (e.removeEventListener("pointerdown", i._handler_onPointerDown),
      e.removeEventListener("pointermove", i._handler_onPointerMoveRefreshCursor))
...
function $(i = {}) {
  ...
  (i._handler_onPointerMoveRefreshCursor = (t = {}) => {
    ...
    (i._handler_onTouchStart = (t = {}) => {
      ...
      function n(a = {}) {
        a.preventDefault(), i.dragMove({ x: a.targetTouches[0].clientX, y: a.targetTouches[0].clientY });
      }
      function r(a = {}) {
        a.preventDefault(),
    ...
    "PointerEvent" in window
      ? (e.addEventListener("pointerdown", i._handler_onPointerDown),
        e.addEventListener("pointermove", i._handler_onPointerMoveRefreshCursor))
...
var B = class {
  ...
  remove() {
    this.canvas !== null &&
      (this._frameRequestId !== null && window.cancelAnimationFrame(this._frameRequestId),
      F(this),
  ...
  resize() {
    ...
    for (let a of this._items)
      this._itemLabelFontSize = Math.min(
        ...
        E(a.label, this.itemLabelFont, this._labelMaxWidth, this._context)
      );
    this.refresh();
  }
  draw(e = 0) {
  ...
  drawItemImages(e, t = []) {
    for (let [s, n] of t.entries()) {
      ...
      e.translate(
        this._center.x + Math.cos(m(a + -90)) * (this._actualRadius * r.imageRadius),
        this._center.y + Math.sin(m(a + -90)) * (this._actualRadius * r.imageRadius)
      ),
  ...
  drawItemLabels(e, t = []) {
    ...
    for (let [a, d] of t.entries()) {
      ...
      if (
        (e.translate(
          this._center.x + Math.cos(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius),
          this._center.y + Math.sin(m(_ + -90)) * (this._actualRadius * this.itemLabelRadius)
        ),
        e.rotate(m(_ + -90)),
        ...
        this.itemLabelAlign === "left"
          ...
          (e.lineWidth = n),
          e.stroke(),
          e.strokeRect(f, -this._itemLabelFontSize / 2, -this._labelMaxWidth, this._itemLabelFontSize),
          e.restore();
      }
      if (
        (this._itemLabelStrokeWidth > 0 &&
          ((e.lineWidth = r), (e.strokeStyle = this._itemLabelStrokeColor), (e.lineJoin = "round"), e.strokeText(h.label, 0, s)),
        (e.fillStyle = C),
        e.fillText(h.label, 0, s),
        this.debug)
      ) {
        let f = this.getScaledNumber(2);
        e.beginPath(), e.arc(0, 0, f, 0, 2 * Math.PI), (e.fillStyle = c.labelRadiusColor), e.fill();
      }
      e.restore();
    }
  }
  ...
  animateRotation(e = 0) {
    ...
    if (this._lastSpinFrameTime !== null) {
      ...
      t > 0 &&
        ...
        this._rotationSpeed === 0 ? (this.raiseEvent_onRest(), (this._lastSpinFrameTime = null)) : (this._lastSpinFrameTime = e)),
        this.refresh();
      return;
    }
  }
  ...
  spinToItem(e = 0, t = 0, s = !0, n = 1, r = 1, a = null) {
    ...
    (h += n * 360 * r),
      this.animate(h, t, a),
      this.raiseEvent_onSpin({ method: "spintoitem", targetItemIndex: e, targetRotation: h, duration: t });
  }
  animate(e, t, s) {
  ...
  getItemAngles(e = 0) {
    ...
    let s = 360 / t,
      ...
      r = e,
      a = [];
    for (let d of this._items) (n = d.weight * s), a.push({ start: r, end: r + n }), (r += n);
  ...
  beginSpin(e = 0, t = "") {
    this.stop(),
      ...
      this._rotationSpeed !== 0 &&
        this.raiseEvent_onSpin({ method: t, rotationSpeed: this._rotationSpeed, rotationResistance: this._rotationResistance }),
      this.refresh();
  }
  refreshAriaLabel() {
    if (this.canvas === null) return;
  ...
  set items(e) {
    (this._items = l({
      ...
      action: () => {
        let t = [];
        for (let s of e) t.push(new S(this, s));
        return t;
      },
    })),
  ...
  dragStart(e = { x: 0, y: 0 }) {
    ...
    (this.isDragging = !0),
      this.stop(),
      (this._dragEvents = [{ distance: 0, x: t.x, y: t.y, now: performance.now() }]),
      this.refreshCursor();
  }
  dragMove(e = { x: 0, y: 0 }) {
    if (this.canvas === null) return;
    let t = v(e, this.canvas, this.getActualPixelRatio()),
      ...
      a = P(r, s);
    this._dragEvents.unshift({ distance: a, x: t.x, y: t.y, now: performance.now() }),
  ...
  raiseEvent_onCurrentIndexChange(e = {}) {
    ...
    (t = this.onCurrentIndexChange) == null ||
      t.call(this, L({ type: "currentIndexChange", currentIndex: this._currentIndex }, e));
  }
  raiseEvent_onRest(e = {}) {
    var t;
    (t = this.onRest) == null || t.call(this, L({ type: "rest", currentIndex: this._currentIndex, rotation: this._rotation }, e));
  }
  raiseEvent_onSpin(e = {}) {
    var t;
    (t = this.onSpin) == null || t.call(this, L({ type: "spin" }, e));
  }
};
export { B as Wheel };
